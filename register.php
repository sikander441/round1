...
<body>
  <div class="container">
            ...
            <form class="form-horizontal" role="form"  method="post">
                ...
                <div class="form-group">
                    <label for="user1" class="col-sm-3 control-label">Name of first member</label>
                    <div class="col-sm-9">
                        <input required type="text" id="user1" placeholder="UserName1" class="form-control" autofocus name='user1'>
                    </div>
                </div>
                <div class="form-group">
                    <label for="email1" class="col-sm-3 control-label">Email id of first member</label>
                    <div class="col-sm-9">
                        <input required type="email" id="email1" placeholder="Email1" class="form-control" name="email1">
                    </div>
                </div>
                <div class="form-group">
                    <label for="user2" class="col-sm-3 control-label">Name of second member</label>
                    <div class="col-sm-9">
                        <input type="text" id="user2" placeholder="UserName2" class="form-control" autofocus name='user2'>
                    </div>
                </div>
                <div class="form-group">
                    <label for="email2" class="col-sm-3 control-label">Email id of second member</label>
                    <div class="col-sm-9">
                        <input type="email" id="email2" placeholder="Email2" class="form-control" name="email2">
                    </div>
                </div>
                <div class="form-group">
